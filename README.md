...
- 713/714 tests green (1 skipped: OCR live smoke gated on billing envelope); GitHub Actions CI 100+ consecutive commits green
- **Cross-vertical persona pack** — `lib/personas/trader-pack/` v0.1.1 scaffold (7 contract tests parallel to Orallexa Python side). Byte-identical wire format lets banking + trading + data-science verdicts share one attestation surface. Not yet wired to `/api/deliberate` — v0.2 will add `?mode=trading` dispatch.
