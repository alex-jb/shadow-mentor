...
// Aligned with the shadow-3d-scene-v1 profile node types so a guided story and its 3D scene share kinds.
export const ENTITY_KINDS = Object.freeze([
  ...
  "dataset", "feature", "model", "metric", "experiment",
  // coding-agent replay
  "issue", "tool_call", "diff", "test", "commit",
]);
