...
//
// Ships 2026-07-02 (v1.5.8) to close the post-2026-07-21 Reg B
// compliance gap. The dictionary is at
// lib/schemas/reason-code-dictionary.json — bank counsel signs
// THAT FILE, not the LLM output. See file docstring for rationale.
//
// v1.5.31 (2026-07-08) positioning update: the Reg B final rule
// takes effect 2026-07-21. See docs/REG-B-2026-07-21-FINAL-RULE.md
// for the full pivot. Runtime behavior of this file is unchanged —
// what changes is the threat model this file defends against:
//   PRE-7/21: federal disparate-impact "effects test"
//   POST-7/21: §1002.9(b)(2) AA-notice specificity
//              + state-AG disparate-impact (NY/CA/CO/IL/MA/WA)
//              + prohibited-basis disparate treatment (unchanged)
// The proxy blocklist stays state-neutral because state-AG
// enforcement is not affected by the federal narrowing.
  ...
  if (prohibited.length > 0) {
    return {
      ...
      reason:
        ...
        `institution to (a) ECOA prohibited-basis disparate-treatment ` +
        `liability (federal, unchanged post-2026-07-21) and ` +
        `(b) state-AG disparate-impact liability in NY/CA/CO/IL/MA/WA ` +
        `(state UDAP + state fair-lending law, unaffected by the ` +
        `federal Reg B narrowing). See docs/REG-B-2026-07-21-FINAL-RULE.md.`,
    };
  }
