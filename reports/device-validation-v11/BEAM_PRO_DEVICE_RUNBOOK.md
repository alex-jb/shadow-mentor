...
# → Build/Android/shadow-lens-v11-beampro-candidate-03.apk  (+ reports/device-validation-v11/build/build-summary.json)
```
...
```
$ADB install -r Build/Android/shadow-lens-v11-beampro-candidate-03.apk
