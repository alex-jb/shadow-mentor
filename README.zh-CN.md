...
- 713/714 测试绿;GitHub Actions CI 连续 15+ commits 绿
- **跨垂类 persona pack** —— `lib/personas/trader-pack/` v0.1.1 scaffold (7 契约测试与 Orallexa Python 端对齐)。字节相同的 wire 格式让 banking + trading + data-science verdict 共享同一 attestation 面。尚未接入 `/api/deliberate` —— v0.2 会加 `?mode=trading` dispatch。
