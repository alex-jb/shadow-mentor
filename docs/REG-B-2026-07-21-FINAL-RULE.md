...
- **The complexity-is-no-excuse principle is unchanged — but it lives in the statute, not a circular.** *Correction (verified 2026-08-05 against consumerfinance.gov Withdrawn Guidance): CFPB Circular 2022-03 was **withdrawn 2025-05-12** (90 FR 20084 mass withdrawal), as was Circular 2023-03. The earlier claim here that 2022-03 was "unchanged" was wrong.* The requirement that a creditor be able to give specific, accurate principal reasons — even for a complex/AI model — is grounded directly in **ECOA 15 U.S.C. §1691 + Reg B 12 CFR §1002.9(b)(2)**, which are unchanged. Shadow now anchors every notice citation on that durable statute; the withdrawn circulars are retained in the registry as historical (sunset) entries only and are never emitted.
- **No "CFPB Circular 2026-03" is cited.** *(An earlier registry alias mapped "Circular 2026-03" to a non-existent "Bulletin 2024-09"; both were removed 2026-08-05 — the bulletin does not exist as an official CFPB document.)* Model-traceability for adverse-action explanations is carried by §1002.9(b)(2)'s specificity requirement, which Shadow's hash-chain + per-decision Ed25519 attestation preserves.
