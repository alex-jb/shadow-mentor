...
- **"Can this be used as evidence in court?"** — That is a legal determination we do not make. We produce a tamper-evident record. Whether a specific rule of evidence in a specific jurisdiction accepts it is a lawyer's job.
