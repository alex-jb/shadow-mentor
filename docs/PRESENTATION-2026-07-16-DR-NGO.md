...
- **v1.5.41 latest release · 1227/1228 tests passing · 22 GitHub Releases live · public repo (github.com/alex-jb/shadow-mentor)**
- **13 append-only cryptographic-attestation fields** covering the load-bearing invariants (dictionary hash · citation registry · protected-class proxy schema · policy-invariance score · adverse-action notice · sampling-seed commitment · evidence-partition scheme · heterogeneity commitment · typed-claim envelope · BIAN coverage · Eticas taxonomy · SIVE fixture set · hash-chain provenance)
- **12 arXiv anchors** (2605.06161 · 2605.20312 · 2606.08285 · 2606.16121 · 2606.19826 · 2606.29142 · 2607.00910 · 2607.01661 · 2607.01740 · 2607.02201 · 2607.04103 · plus RFC 8032 Ed25519)
- **6 regulatory anchors** (SR 26-2 (GenAI/agentic AI carved out by footnote 3) · CFPB Circular 2022-03 · CFPB Circular 2026-03 · Reg B final rule 2026-07-21 · GDPR Art. 22 + Schufa C-634/21 · Colorado SB 26-189)
- **11 releases shipped today alone** (v1.5.31 → v1.5.41) driven by (1) Reg B final rule takes effect 2026-07-21 = 13 days out, (2) Norm AI raised $120M Series C @ $1.2B unicorn 2026-07-07, (3) SIVE test rig (v1.5.41, arXiv:2607.00910) exposed 3 real baseline findings we now publish
- **Honest posture: 3 SIVE-exposed baseline findings documented in `docs/SIVE_BASELINE_FINDINGS.md`** — Shadow is the first OSS banking-council system to publish its own response-function pathologies rather than hide them
