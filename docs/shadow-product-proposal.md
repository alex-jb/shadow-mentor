...
author:
  - Alex Xiaoyu Ji
date: 2026-06-17 (v1.0 — canonical product proposal)
...
**Canonical product proposal v1.0** — supersedes all prior framing of council-diff, ECC banking-quest, ECC trading-quest as separate products. Going forward, *all four projects share one product narrative and one architectural diagram*.
